...
*/
	...
	@Override
	public List<PrescriptionDetails> getAllPrescriptionData(String clientId) {
		// TODO Auto-generated method stub
		return entityManager.createQuery("select prescription from PrescriptionDetails prescription  where prescription.clientId='"+clientId+"'",PrescriptionDetails.class).getResultList();
	}
...
boolean bol = false;
	...
	@Override
	public List<OrderCardView> getAllCustomerOrderListData(String clientId) {
		// TODO Auto-generated method stub
