...
public class JobsDaoImpl implements JobsDao
{
	...
	@Override
	public List getOrderJobsList(String orderId)
	{
		return entityManager.createQuery("select jobsList from JobListView jobsList where jobsList.orderId='"+orderId+"'",JobListView.class).getResultList();
	}
}
