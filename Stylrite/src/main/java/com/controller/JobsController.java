...
public class JobsController
{
    ...
    /*** Creating a add new Order Jobs Item ***/
	  ...
	  public @ResponseBody int addNewJobsItemForvendorFittingFrameAndSunglassData(@ModelAttribute("jobsItem") JobsItem jobsItem, BindingResult br, @RequestParam("vendorFittingFrameAndSunglassArray") JSONArray vendorFittingFrameAndSunglassArray)
	  {
	    ...
	    @RequestMapping(value="/getFrameAndSunglassJobsList", produces="application/json",method=RequestMethod.GET)
		public @ResponseBody HashMap getFrameAndSunglassJobsListData(Model model,HttpSession session) 
	    {
	    		HashMap<String, Object> hm = new HashMap();
			
			 	List lsitGetFrameAndSunglassListData = jobsService.getFrameAndSunglassJobsList();
