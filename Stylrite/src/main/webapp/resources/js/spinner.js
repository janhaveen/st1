(function ($) {
	...
	$.fn.drawCircle = function(a){
		...
		var args = $.extend({
			...
			r:80, 									// the radius of the circles
			railHighlightColor:'rgba(0, 0, 0, 0)', 	// the color of the rail
			railFill:'none', 						// the fill color of the rail
			railStrokeColor:'#ffffff', 				// the stroke color of the rail
			railStrokeWidth:5, 						// the stroke width of the rail
			...
			pathStrokeWidth:10					// the path's stroke width
		},a);
