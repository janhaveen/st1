    	 ...
    	 $('#showFrameAndSunglassTableList tbody').on( 'click', '.select_me', function () 
    	 {
    				...
    				var table1 = document.getElementById('frameAndSunglassProductDataBody');
    		 		...
    		 		else 
    		 		{
	    				...
	    				vendorFittingFrameAndSunglassArray.push({"jobItemId":"JIId"+generator.generate(), "jobId":$("#jobId").val(), "barcode": data.barcode, "skuId":productInfo, "qty": 1, "status":"601"});
...
function getOrderJobsList(orderId) 
{
		//spinnerOn();
    		...
    		// dom: 'Bfrtip',
             buttons: [
             	...
             	"bLengthChange": false,
      			...
      			"bScrollCollapse": true,
              "ajax": {
                  "url": "getOrderJobsList?orderId="+orderId,
                //  "dataSrc": "" 
              },
              //'processing': true,
              'dataType': "json",
