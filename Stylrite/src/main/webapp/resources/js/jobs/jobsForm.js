$(document).ready(function()
{
  ...
  $("#SubmitButtonOrderJobs").click(function()
    ...
    $("#closeBtn").click(function() 
    {
     ...
     {
    	 //console.log($("#OrderIDText").val());
    	 
    	 $.ajax
    	    ({  
    	    	type:"POST",
    	    	url:"addNewOrderJobs",
    	    	data:$("#insertVendorFittingData").serialize()+"&rowId="+$("#jobId").val()+"&orderId="+$("#OrderIDText").val()+"&expectedDeliveryDate="+$("#expectedDeliveryDate").val()+"&remarks="+$("#remarks").val(),
    	    	success:function(data)
    	    	{
    	     	    ...
    	     	    ({  
    	     	    	...
    	     	    	success:function(data)
    	     	    	{
    	     	    		...
    	     	    		getOrderJobsList($("#OrderIDText").val());
