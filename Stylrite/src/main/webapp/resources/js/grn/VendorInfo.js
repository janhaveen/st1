		    ...
		    ({
		          ...
		          success: function(data)
		          {
		      			...
		      			for (var i = 0; i < qty; i++) 
		      			{
		      				...
		      				createBarcodeArray.push({"barCodeRowId": "STYRL"+generator.generate(), "productId": productId, "grnNo": grnNo, "grnId": $("#grnId").val(), "brand": brand, "modelNo": modelNo, "color": color, "size": size, "qty":qty, "cost":cost, "type":type, "price":price, "hsnId":hsnId});
