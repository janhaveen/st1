					...
					for (var i = 0; i < data2.data.length; i++) 
					{
						...
						else
						{
							...
							html = '<tr id="productBasedIdRow'+rowCounter+'">'+
							 ...
							 orderItemArray.push({"orderItemId":"OItemId"+generator.generate(), "orderId":$("#orderId").val(), "barcode": data2.data[i].rowId, "brand": data2.data[i].brand, "color": data2.data[i].color, "size": data2.data[i].size, "price":data2.data[i].price, "barcodeStatus":statusValue, "modelNo":data2.data[i].modelNo, "qty": qtyValue, "tax":tax, "discount": discountVal, "amount":$('#amt'+rowCounter).html(), "status":"601"});
