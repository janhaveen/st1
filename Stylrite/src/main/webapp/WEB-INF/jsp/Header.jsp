	            ...
	            <li id="300001">
	             ...
	             <li id="130001">
	              ...
	              <li id="1200001">
	               ...
	               <li id="1300001">
				  	<a class="collapsible-header waves-effect arrow-r" data-toggle="collapse" data-target="#hsn"><i class="fa fa-users"></i> HSN <i class="fa fa-angle-down pull-right"  ></i></a>
	               	 <div class="collapse" id="hsn"  data-parent="#accordion">
	               		<ul>
	               			<li id="1300002"><a href="showHsn" class="waves-effect">HSN List</a>
	                         </li>
	               		</ul>
	              	  </div>
	               </li>
        ...
        <ul class="navbar-nav">
            <li class="nav-item" id="15000000">
                <a style="font-size: 120% !important; color:  white;" class="nav-link dropdown-toggle waves-effect" href="#" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <i class="fa fa-user" style="color:white;"></i> <span class="clearfix d-none d-sm-inline-block" style="font-size:15px;color:white;"><%=session.getAttribute("empName") %></span>
                </a>
