                        ...
                        <form id="insertHsnData" name="insertHsnData">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
	                               <label id="hsnNamelbl" for="hsnName" class="">HSN <span class="mandatory-element">*</span></label>
	                               <input type="text" class="form-control capitalizeText" id="hsnName" name="hsnName" placeholder="HSN Name">
                                </div>
                            ...
                            <div class="left">
                                <button type="button" class="btn btn-sm btn-primary" id="SubmitButtonHsn">Submit</button>
                                <button type="button" class="btn btn-sm btn-primary HideThisElement" id="UpdateButtonHsn">Update</button>
