                ...
                <div class="card HideThisElement" id="saveBrandDiv">
                    <div class="card-body">
                        ...
                        <form id="insertBrandData" name="insertBrandData">
                            ...
                            <div class="left">
                                <button type="button" class="btn btn-primary" id="SubmitButtonBrand">Submit</button>
                                <button type="button" class="btn btn-primary HideThisElement" id="UpdateButtonBrand">Update</button>
